...
1. `python3 -m py_compile src/esp32_mcp_io_extender/bridge.py src/esp32_mcp_io_extender/mcp_server.py src/esp32_mcp_io_extender/cli.py src/esp32_mcp_io_extender/uart_pty.py src/esp32_mcp_io_extender/workbench.py`
...
- PTY daemon aliases must be explicit (`--path`) and cleaned up on stop/crash.
